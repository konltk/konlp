...
""" KNU 한국어 감성사전 
  ...
  KNU 한국어 감성사전에 대한 정보는 https://github.com/park1200656/KnuSentiLex에서 참조하면 됩니다.
...
class KnuSL():
    ...
    def data_list(wordname):	
        ...
        단어를 입력 받아 형태소 분석 결과와 입력 받은 단어의 극성 값을 출력합니다.
        ...
        Args:
            wordname(str): 감성정보에 대해 알고자 하는 단어

        Returns:
            형태소 분석된 단어와 극성 값을 tuple로 제공
            r_word(str): 형태소 분석된 단어
            s_word(str): 단어에 대한 극성 값
